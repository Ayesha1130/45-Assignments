...
make_album() that allows you to store the number of tracks on an album. If the 
...
let album1 = makeAlbum("Ali Raza" , "Album no 1")
console.log(album1)

let album2 = makeAlbum("Zaviyar" , "Album no 2")
console.log(album2)

let album3 = makeAlbum("Hussain" , "Album no 3",20)
console.log(album3)
