...
Cars: Write a function that stores information about a car in
a Object. The function should always receive a manufacturer and
a model name. It should then accept an arbitrary number of
...
var my_car = create_car("Toyota", "Corrolla", "Color: Black", "Bulletproof: True");
console.log(my_car);
